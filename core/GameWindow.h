...
public:
	...
	////////////////////////////////////////////////////////
	static void pushDrawable(const sf::Drawable& drawable);
	...
	static void popDrawable(const sf::Drawable& drawable) noexcept;
...
private:
	...
	static std::vector<const sf::Drawable*> s_drawVector;
